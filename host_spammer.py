...
# def login(br):
#     try:
#         br.click_link_by_href("/webapp/wcs/stores/servlet/LogonForm?langId=-1&storeId=10051&catalogId=10051")
#         br.fill("logonId",user)
#         br.fill("logonPassword",pw)
...
# comp_user = getuser()
# if comp_user == "aashiq":
#     dirname = "/Users/aashiq/Dropbox/Pappy/"
